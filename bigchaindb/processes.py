...
def start():
    ...
    # "subscribe" to peers that "publish" transactions
    # this process connects to peers, and manages the connections, i.e.: retry
    # if the connection is lost, etc maintains the connection pool
    peers.connect()
